            ...
            <section className="about-wrapper mt-8 mb-5">
                <div className="container-full px-10">
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                        <div className="bg-[#BE7316] flex flex-col justify-between col-span-12 md:col-span-12 lg:col-span-4 rounded-xl p-8 shadow-lg border-2 border-black">
                            <div>
                            ...
                            <div className="hire-btn text-center bg-[#E5A137] hover:bg-[#F7D990] text-black font-bold py-2 px-6 transition duration-300 rounded-full border-2 border-black">
                                <Link href="/contact" className="text-xl">Hire Now</Link>
                            </div>
                        </div>
